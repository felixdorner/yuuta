...
<div id="col-container">
	<div id="col-right" style="padding-left: 30px;">		
		...
		<p><a href="https://wordpress.org/support/theme/yuuta" class="button"><?php esc_html_e( 'Support Forum', 'yuuta' ); ?></a> <a href="mailto:mail@felixdorner.de" class="button"><?php _e( 'Inquire Customization', 'yuuta' ); ?></a></p>
...
<p style="font-size: 1.2em; padding: 1.618em 0; margin: 1.618em 0 2.618em 0; border-top: 1px solid rgba(0,0,0,0.1); border-bottom: 1px solid rgba(0,0,0,0.1);">
	<?php echo sprintf( esc_html__( 'Looking for more themes? Take a look at my collection. %sMore themes &rarr;%s', 'yuuta' ), '<a href="http://felixdorner.de" class="button-primary" style="float: right;">', '</a>' ); ?>
</p>
