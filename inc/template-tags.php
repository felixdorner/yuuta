...
function yuuta_entry_footer() {
	...
	// 	comments_popup_link( __( 'Leave a comment', 'yuuta' ), __( '1 Comment', 'yuuta' ), __( '% Comments', 'yuuta' ) );
	// 	echo '</span>';
	// }
...
function yuuta_password_form() {
    ...
    ' . _x( 'To view this protected post, enter the password below:', 'yuuta' ) . '
    <label for="' . $label . '">' . __( 'Password:', 'yuuta' ) . ' </label><input name="post_password" id="' . $label . '" type="password" size="20" maxlength="20" /><input type="submit" name="Submit" value="' . esc_attr__( "Submit" ) . '" />
    </form>
    ';
    return $o;
}
